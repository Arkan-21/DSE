...
# CEA input
fuel            = 'H2(L)'              # choose existing fuel or oxidiser from rocketcea or create new fuel or oxidiser blend in PropLibrary
ox              = 'LOX'
...
MR              = 0.5*0.5
m_dot           = 28                                # total mass flow [kg/s]
m_dot_f         = m_dot / (MR + 1)
m_dot_ox        = m_dot - m_dot_f
Pc              = 1e5                               # Chamber pressure [Pa]

# Coolant input
cooling_fluid   = ['H2']                            # needs to be list of str
...
inlet_temp      = 20                     		 # inlet temperature [K]
inlet_pressure  = 10e5                               # Cooling channel inlet pressure [Pa]
...
ambient_temp    = 120							 # ambient temperature for radiation boundary condition [K] (must be type float)!!
