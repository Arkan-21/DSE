...
if __name__ == "__main__":
    ...
    # best = optimise_intake(M_inf=5.0, y_cowl=1.1968, delta_cowl_deg=4, L1_range=(0.01, 3), 
    #                        theta1_range=(1.0, 20.0), max_oblique_shocks= 4, M_exit_max=0.8, L1_step=0.005, print_all=True)
    # print("\nBest configuration")
    # print("------------------")
    # print(f"L1      = {best['L_1']:.4f}")
    # print(f"L2      = {best['L_2']:.4f}")
