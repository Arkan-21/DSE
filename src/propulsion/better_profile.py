...
RAMJET_FILE = source_file("propulsion", "ramjet_revised.py")
TURBOJET_FILE = source_file("propulsion", "turbojet_pycycle_wrapper.py")

TURBO_MAP_FILE = thrust_map_file("turbojet_multidesign_thrust_maps.npz")
RAMJET_MAP_FILE = thrust_map_file("ramjet_multidesign_thrust_maps.npz")
...
TURBO_CALIBRATION_FILE = thrust_map_file("turbojet_surrogate_calibration.npz")
RAMJET_CALIBRATION_FILE = thrust_map_file("ramjet_surrogate_calibration_limited_mach_alt.npz")
