...
PYCYCLE_DIR = PROJECT_ROOT / "external" / "pycycle"

if str(PYCYCLE_DIR) not in sys.path:
    sys.path.insert(0, str(PYCYCLE_DIR))

from pycycle_examples.afterburning_turbojet import MPABTurbojet
